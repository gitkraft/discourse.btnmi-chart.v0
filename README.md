...
# GitKraft's `discourse` Helm Chart
...
<p align="center">
    <a href="https://gitkraft.com/router?gk_operation=fork&gk_name=discourse.btnmi-chart.v0&gk_template_owner=tpl-gitkraft&gk_template_name=tpl.discourse.btnmi-chart.v0&gk_description=Helm%20chart%20for%20discourse%2C%20managed%20with%20GitKraft%20tooling&gk_visibility=private&mtm_campaign=fork&mtm_kwd=discourse.btnmi-chart.v0">
...
This repository hosts the GitKraft's open-source **discourse** Helm chart, originally
